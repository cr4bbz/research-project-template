...
`docs/RENDER_LOG.md`. The checker protects an existing version/date render from being
overwritten by changed sources. Tracked TeX remains the authoritative artefact.
