...
- [ ] `CITATION.cff` has replaced the example with real authors, version, and date.
...
- [ ] Tag the exact commit (`vMAJOR.MINOR.PATCH`); attach the generated paper PDF and
  result artefacts to the GitHub release or a suitable long-term archive.
